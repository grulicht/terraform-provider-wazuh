...
| Name | Type |
|------|------|
| [wazuh_manager_restart.restart](https://registry.terraform.io/providers/grulicht/wazuh/latest/docs/resources/manager_restart) | resource |
...
| Name | Description |
|------|-------------|
| <a name="output_manager_restart_affected"></a> [manager\_restart\_affected](#output\_manager\_restart\_affected) | n/a |
| <a name="output_manager_restart_message"></a> [manager\_restart\_message](#output\_manager\_restart\_message) | n/a |
<!-- END_TF_DOCS -->