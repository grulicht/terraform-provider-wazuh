...
| [wazuh_group_configuration.group_configuration](https://registry.terraform.io/providers/grulicht/wazuh/latest/docs/resources/group_configuration) | resource |
...
| <a name="input_wazuh_configuration_xml"></a> [wazuh\_configuration\_xml](#input\_wazuh\_configuration\_xml) | Custom XML configuration for the Wazuh agent group. | `string` | `"<agent_config>\n  <localfile>\n    <log_format>syslog</log_format>\n    <location>/var/log/auth.log</location>\n  </localfile>\n</agent_config>\n"` | no |
