...
| Name | Type |
|------|------|
| [wazuh_agent_restart_group.agents](https://registry.terraform.io/providers/grulicht/wazuh/latest/docs/resources/agent_restart_group) | resource |

## Inputs

| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| <a name="input_wazuh_agent_restart_group_id"></a> [wazuh\_agent\_restart\_group\_id](#input\_wazuh\_agent\_restart\_group\_id) | ID of the Wazuh agent group whose agents should be restarted. | `string` | `"NewGroup_1"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_restart_group_message"></a> [restart\_group\_message](#output\_restart\_group\_message) | n/a |
<!-- END_TF_DOCS -->