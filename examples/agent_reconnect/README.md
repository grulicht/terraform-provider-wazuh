...
| Name | Type |
|------|------|
| [wazuh_agent_reconnect.all_agents](https://registry.terraform.io/providers/grulicht/wazuh/latest/docs/resources/agent_reconnect) | resource |
...
| Name | Description |
|------|-------------|
| <a name="output_reconnect_all_message"></a> [reconnect\_all\_message](#output\_reconnect\_all\_message) | n/a |
<!-- END_TF_DOCS -->