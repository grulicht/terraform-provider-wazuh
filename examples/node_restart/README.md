...
| Name | Type |
|------|------|
| [wazuh_node_restart.all_nodes](https://registry.terraform.io/providers/grulicht/wazuh/latest/docs/resources/node_restart) | resource |
| [wazuh_node_restart.some_nodes](https://registry.terraform.io/providers/grulicht/wazuh/latest/docs/resources/node_restart) | resource |
...
| Name | Description |
|------|-------------|
| <a name="output_node_restart_message"></a> [node\_restart\_message](#output\_node\_restart\_message) | n/a |
| <a name="output_node_restart_total_affected"></a> [node\_restart\_total\_affected](#output\_node\_restart\_total\_affected) | n/a |
<!-- END_TF_DOCS -->